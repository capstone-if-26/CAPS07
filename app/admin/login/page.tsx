...
export default function AdminLoginPage() {
  ...
  const getErrorType = (code: string): ErrorType => {
    ...
    if (code === "INVALID_PASSWORD" || code === "WRONG_PASSWORD") return "password"
    return "general"
  }
        ...
        <div className="card">
          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="field-wrap">
              ...
              <div className={`input-wrap${isEmailError ? " input-error" : ""}`}>
                <span className={`input-icon${isEmailError ? " icon-error" : ""}`}>
            ...
            <div className="field-wrap">
              ...
              <div className={`input-wrap${isPasswordError ? " input-error" : ""}`}>
                <span className={`input-icon${isPasswordError ? " icon-error" : ""}`}>
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <input
                  ...
                  value={password}
                  onChange={(e) => { setPassword(e.target.value); setError(null); setErrorType(null) }}
                  placeholder="••••••••"
                  required
                />
          ...
          <p className="footer-text">
            Butuh bantuan? <a href="mailto:support@ojk.go.id">Hubungi Support</a>
          </p>
        </div>
      </div>
    </>
